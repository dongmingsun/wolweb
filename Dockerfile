...
LABEL org.label-schema.vcs-url="https://github.com/dongmingsun/wolweb.git" \
      org.label-schema.url="https://github.com/dongmingsun/wolweb.git"
...
RUN apk update && apk upgrade && \
    ...
    git clone https://github.com/dongmingsun/wolweb.git . && \
    go mod init wolweb && \
